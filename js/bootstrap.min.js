...
if (currentfile === "indexfullpagedesign.html" || currentfile === "indexfullpagedesign.html#") {
	if ($(window).width() < 768) {
...
$('.contact').on('click', function() {
	if ($(window).width() > 768) {
		...
		$('input:first-child').css({'left': '25%', 'z-index': '300', 'top':'87%'});
		$('input:nth-child(2)').css({'left': '35%', 'z-index': '300', 'top':'87%'});
		$('input:nth-child(3)').css({'left': '65%', 'z-index': '300', 'top':'87%'});
		$('input:nth-child(4)').css({'left': '75%', 'z-index': '300', 'top':'87%'});
	}
})
